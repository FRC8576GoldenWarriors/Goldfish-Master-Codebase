...
public class Macros {
  ...
  public static SequentialCommandGroup A1_DEALGAE_MACRO_V2( Arm arm, Shintake shintake, EndEffector endEffector, GroundIntake groundIntake){
    SequentialCommandGroup command = new SequentialCommandGroup(
       ...
       new ParallelRaceGroup(
            new ParallelDeadlineGroup(new WaitCommand(0.0), new EndEffectorController(endEffector,  Constants.EndEffectorConstants.ControlConstants.pincherInSpeed)),
       ...
       new ParallelCommandGroup(
            ...
            new GroundIntakeController(groundIntake, 0.175, 0.0) //TUNE ANGLE
       )
       .until(() -> Math.abs(arm.getEncoderPosition()-Constants.ArmConstants.ControlConstants.handoffPosition) <0.015 ), //WHEN ARM IN ERROR, CONTINUE ON

       //HANDOFF AND BEGIN TRANSFER TO HOLD
        new ParallelCommandGroup(
            new ArmController(arm, Constants.ArmConstants.ControlConstants.handoffPosition),
            new SequentialCommandGroup(
                new WaitCommand(0.2), //TUNE
                new EndEffectorController(endEffector, Constants.EndEffectorConstants.ControlConstants.pincherInSpeed) //SMALL DELAY TO ENSURE FF INITIALIZES
            ),
            new ShootSetSpeeds(shintake, -0.4),
            new GroundIntakeController(groundIntake, 0.175, 0.0)
        ...
        new ParallelCommandGroup(
            ...
            new ShootSetSpeeds(shintake, -0.3).withTimeout(0.3).withTimeout(0.2), //TUNE
            new GroundIntakeController(groundIntake, 0.175, 0.3).withTimeout(0.3) //TUNE
        ),
