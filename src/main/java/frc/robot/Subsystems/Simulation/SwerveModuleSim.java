...
public class SwerveModuleSim extends SubsystemBase {
  ...
  public SwerveModuleSim(
    ...
    SmartDashboard.putNumberArray(
        key1_M,
        new double[] {
          driveSim.getVelocity(),
          this.getDriveMotorVelocity(),
          driveSim.getPosition(),
    ...
    SmartDashboard.putNumberArray(
        ...
        new double[] {
          turnSim.getVelocity(),
          this.getTurnMotorVelocity(),
          turnSim.getPosition(),
          this.getTurnMotorPosition()
        });
  ...
  public void setSpeed(SwerveModuleState desiredState) {
    driveSim.setVelocity(desiredState.speedMetersPerSecond);
  }
  ...
  public void setRobotPosition() {
    driveSim.setAngle(driveSim.getAngle() + driveSim.getVelocity() * driveSim.getInterval());
  }
